...
class OrdersTest(unittest.TestCase):
    ...
    def test_invalid_order_item(self):
        ...
        """
        with self.client as client:
            response = client.post(BASE_URL, json=dict(client='Aisha Naka',contact='0700687656', \
    ...
    def test_order_deleted(self):
        ...
        with self.client as client:
            client.post(BASE_URL, json=dict(client='Dian', contact='0700687656', \
            order_item="kebabs", price="10000"))
            client.post(BASE_URL, json=dict(client='Tom', contact='0700687656', \
            order_item="pizza", price="10000"))
            client.post(BASE_URL, json=dict(client='Caltic', contact='0700687656', \
            order_item="pizza", price="10000"))
